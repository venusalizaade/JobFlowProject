        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    About = table.Column<int>(type: "int", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AttachmentsFiles_AspNetUsers_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_NotificationLogs_AspNetUsers_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttachmentsFiles_ProfileId",
                table: "AttachmentsFiles",
                column: "ProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationLogs_ProfileId",
                table: "NotificationLogs",
                column: "ProfileId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ActivityLogs_AspNetUsers_ProfileId",
                table: "ActivityLogs",
                column: "ProfileId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
